        ...
        <div class="col-xs-12">
            <div class="panel panel-success">
                <div class="panel-heading">
                    <h3 class="panel-title"><span class="fa fa-user-plus"></span> Laporan Penjualan Roti</h3>
                </div>
                <div class="panel-body">
                    <table id="dtskripsi" class="table table-bordered table-striped table-hover">
                        <thead>
                            <tr>
                                <th><center>No.</center></th><th><center>Nama Roti</center></th><th width="14%"><center>Jumlah</center></th><th width="15%"><center>Harga</center></th><th><center>AKSI</center></th>
                            </tr>
                        </thead>
                        <tbody>
