        ...
        <div class="col-xs-12">
            <div class="panel panel-success">
                <div class="panel-heading">
                    <h3 class="panel-title"><span class="fa fa-user-plus"></span> Laporan Roti Kadaluarsa</h3>
                </div>
                <div class="panel-body">
                    <table id="dtskripsi" class="table table-bordered table-striped table-hover">
                        <thead>
                            <tr>
                                <th>No.</th><th><center>Kode Roti</center></th><th><center>Nama Roti</center></th><th><center>Jenis Roti</center></th><th width="14%"><center>Jumlah</center></th><th><center>AKSI</center></th>
                            </tr>
                        </thead>
                        <tbody>
                            ...
                            while ($data = mysqli_fetch_array($query)) {
                                ...
                                <tr>
                                    ...
                                    <td><?= $data['jumlah'] ?></td>
                                    <td>
                                        <a href="report/laporan_satu.php?id=<?= $data['id'] ?>" target="_blank" class="btn btn-info btn-xs">
                            ...
                            <tr>
                                <td colspan="9">
                                    <a href="report/laporan_semua.php" target="_blank" class="btn btn-info btn-sm">
                                        <span class="fa fa_print"></span> Cetak Semua Data Roti
                                    </a>
                                </td>
                            </tr>
                        </tfoot>
