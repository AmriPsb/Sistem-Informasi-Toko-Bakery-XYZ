            ...
            <div class="panel panel-success">
                ...
                <div class="panel-body">
                    <table id="dtskripsi" class="table table-bordered table-striped table-hover">
                        <thead>
                            <label class="col-sm-12 control-label"><center><strong>TOKO BAKERY XYZ</strong></center></label>
                            <p align="center">
                        ...
                        <tbody>
                          ...
                          <div class="col-sm-8" align="center">
                            <br>
                            Depelover :<br>
                            Eka Darmayanti Lubis (17220396)<br>
                            Faisal Amri Pasaribu (17220080)<br>
                            Sitiara Wulandari Panjaitan (17220097)
                            <br>
                          </div>
                          <div class="col-sm-2" align="center">
                          </div>
