...
<html>
    <head>
        <title>Cetak Semua Data Roti</title>
            ...
            <div class='row'>
                <div class="col-sm-12">
                    ...
                    <div class="text-center">
                        ...
                        <hr>
                        <h3>DATA SELURUH ROTI KADALUARSA</h3>
                        <table class="table table-bordered table-striped table-hover"> 
                        <tbody>
                                <thead>
								<tr>
									<th>No.</th><th width="18%"><center>Kode Roti</center></th><th><center>Nama Roti</center></th><th width="14%"><center>Jenis Roti</center></th><th width="15%"><center>Jumlah Roti</center></th><th width="10%">Harga</th>
								</tr>
								</thead>
							<tbody>
